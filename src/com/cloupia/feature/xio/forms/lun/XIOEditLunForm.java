...
public class XIOEditLunForm {
	@FormField(label = "Name", help = "Enter the name for the LUN")
 	private String name;
    ...
    @FormField( label = "Size (GB)", help = "Enter the size of the LUN in GB", type = FormFieldDefinition.FIELD_TYPE_NUMBER, minValue = 1 , maxValue = XIOConstants.XIO_MAX_LUN_SIZE )
    private int size;
